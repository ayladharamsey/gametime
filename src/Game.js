...
class Game {
  ...
  endRound1And2() {
    if (this.currentRoundNum === 1 && this.currentRound.remainingCardCount === 0) {
      this.currentRoundNum++
      this.determineRoundWinner(this.playerSet);
    } else if (this.currentRoundNum === 2 && this.currentRound.remainingCardCount === 0) {
      this.currentRoundNum++
      this.determineRoundWinner(this.playerSet);
    }
